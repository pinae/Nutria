...
import de.ct.nutria.LoggedFooditemFragment.OnListFragmentInteractionListener
...
class LoggedFooditemRecyclerViewAdapter(
    ...
    inner class ViewHolder(val mView: View) : RecyclerView.ViewHolder(mView) {
        val mIdView: TextView = mView.loggedFoodName
        val mContentView: TextView = mView.loggedFoodManufacturer
